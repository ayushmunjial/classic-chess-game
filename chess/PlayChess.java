/*************************************************************************************************************************************** 
 * Compilation: javac chess/*.java | Execution: java java chess.PlayChess
 * Delete .class files: cd chess | find . -name "*.class" -type f -delete
***************************************************************************************************************************************/
...
public class PlayChess {
	...
	public static void main(String[] args) {
        ...
        Scanner sc = new Scanner(System.in); Chess.start(); String line = sc.nextLine();
        
		while (!line.equals("quit")) {

			if (line.equals("reset")) {
				Chess.start(); System.out.println(); line = sc.nextLine();
				continue;
			}
			
			ReturnPlay res = Chess.play(line); // Move 
			
			// Print result message
			if (res.message != null) { System.out.println("\n"+res.message); }
			System.out.println();
			
			// Print result board
			printBoard(res.piecesOnBoard); 
            System.out.println(); line = sc.nextLine(); // Go to the next line
		} sc.close();
	}
